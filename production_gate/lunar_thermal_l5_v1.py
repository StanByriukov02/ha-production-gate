...
from production_gate.lunar_package_thermal_path_v1 import package_thermal_path_dict
...
def radiative_net_flux_w_m2(
    ...
    *,
    ...
    from production_gate.vacuum_radiative_bc_on_v1 import ORACLE as RAD_ORACLE
    from production_gate.vacuum_radiative_bc_on_v1 import flux_from_catalog
