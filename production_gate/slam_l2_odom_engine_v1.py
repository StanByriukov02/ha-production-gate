...
from production_gate.slam_l1_event_engine_v1 import run_l1_event_engine
...
def _frames_from_l1(l1: dict[str, Any]) -> tuple[list[list[Vec3]], dict[str, Any]]:
    ...
    from production_gate.slam_l1_event_engine_v1 import _trajectory_frames_from_dataset
