...
from production_gate.chip_mission_situation_inherit_v1 import build_situation_inherit_packet
from production_gate.fleet_relay_plan_v1 import carrier_chain
...
def apply_clifford_bind(state: dict[str, Any], *, profile_id: str) -> dict[str, Any]:
    ...
    from production_gate.lie_integrator_port_v1 import ensure_lie_integrator_bind
