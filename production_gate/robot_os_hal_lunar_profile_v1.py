...
from production_gate.robot_os_hal_sim_v1 import (
...
def evaluate_lunar_traverse_tick(
    ...
    *,
    ...
    if use_material_catalog and (variant_id or (state and state.get("material_physics_bind"))):
        from production_gate.material_tick_ingress_v1 import evaluate_lunar_row_with_material
...
def wire_lunar_hal_to_kernel(
    ...
    *,
    ...
    if radiation_enabled:
        from production_gate.robot_os_radiation_bind_v1 import apply_radiation_tick, init_radiation_bind
    ...
    def on_tick_after(cid: str, carrier: dict[str, Any]) -> None:
        ...
        from production_gate.robot_os_policy_only_actuation_v1 import policy_only_enabled
