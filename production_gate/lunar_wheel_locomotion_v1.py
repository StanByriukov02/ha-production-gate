...
from production_gate.lunar_dust_ingress_v1 import SiteZone
from production_gate.lunar_regolith_bearing_v1 import (
...
def compare_traverse_ingress_paths(
    *,
    ...
    from production_gate.lunar_robot_articulation_v1 import ingress_for_articulation
