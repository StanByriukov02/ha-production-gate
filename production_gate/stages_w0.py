...
from production_gate.bti_calibration import compute_delta_vth_cited_anchor
from production_gate.nmp_kinetics import integrate_nmp, integrate_nmp_v2_operating, load_traps
from production_gate.fidelity import RegionTag
from production_gate.scheduler import StageSpec
...
def compute_bti_structure(workload: dict[str, Any], spaf: dict[str, Any]) -> dict[str, Any]:
    ...
    if cal_id == "hci_d4_power_scale_v1":
        ...
        try:
            from production_gate.nmp_kinetics import _PARAMS_PATH, _PARAMS_PATH_V2
