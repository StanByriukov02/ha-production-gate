...
def list_chain_ids() -> list[str]:
    ...
    from production_gate.appendage_registry_persist_v1 import load_persisted_chains
...
def resolve_chain_spec(chain_id: str) -> dict[str, Any]:
    ...
    if entry.get("source_fixture"):
        ...
        from production_gate.urdf_to_chain_ir_v1 import compile_urdf_to_chain_spec, flatten_revolute_chain, parse_urdf_tree
...
class Se3ChainBackend:
    ...
    def fk(self, q: list[float], *, g: float = 1.62, build: bool = False) -> dict[str, Any]:
        from production_gate.manipulator_kinematics_port_v1 import _native_call
