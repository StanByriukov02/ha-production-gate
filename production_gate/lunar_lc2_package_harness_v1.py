...
from production_gate.lunar_materials_l1_v1 import MATERIALS_L1, material_snapshot
from production_gate.lunar_site_burial_v1 import burial_column, burial_thickness_m
...
def regolith_rho_variant_dict(regolith_rho_branch: _REGOLITH_RHO_BRANCH) -> dict[str, Any]:
    from production_gate.lunar_regolith_psd_v1 import effective_k_with_psd
