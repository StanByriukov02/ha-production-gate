...
def run_production_gate_ritual(*, write_receipt: bool = True) -> dict[str, Any]:
    ...
    from production_gate.physics_os_kernel_v1 import inspect_soft_mint_claims
    from production_gate.robot_project_desk_v1 import attach_body_from_preset, create_project
