...
from production_gate.open_seed_paths_v1 import gap_mr11_adapt_closure_path, kls1_bevameter_bind_path
...
def q_c_kpa_at_depth_mm(depth_mm: float) -> float:
    ...
    from production_gate.li_bearing_qc_on_v1 import qc_from_catalog
...
def bekker_pressure_kpa_kls1(
    ...
    *,
    ...
    from production_gate.terramech_bekker_on_v1 import ORACLE, evaluate_pressure_from_z
...
def sinkage_mm_for_pressure_kpa_kls1(
    ...
    *,
    ...
    from production_gate.terramech_bekker_on_v1 import ORACLE, evaluate_soil
