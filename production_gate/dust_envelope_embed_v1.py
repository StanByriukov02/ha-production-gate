...
def _dust_pack() -> dict[str, Any]:
    from production_gate.coulomb_loft_on_v1 import load_coulomb_loft_catalog
    from production_gate.soiling_thermal_bc_on_v1 import load_soiling_catalog
    from production_gate.surface_charging_on_v1 import load_surface_charging_catalog
...
def _peer_metric(*, condition: ConditionId, pack: dict[str, Any]) -> float:
    from production_gate.coulomb_loft_on_v1 import evaluate_coulomb_loft
    from production_gate.soiling_thermal_bc_on_v1 import evaluate_soiling_bc
    from production_gate.surface_charging_on_v1 import evaluate_surface_charging
