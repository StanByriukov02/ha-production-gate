...
def _env_pack() -> dict[str, Any]:
    from production_gate.battery_peukert_on_v1 import load_battery_catalog
    from production_gate.eclipse_umbra_on_v1 import load_eclipse_catalog
    from production_gate.fourier_flux_on_v1 import load_fourier_catalog
    from production_gate.rad_damage_tid_on_v1 import load_tid_catalog
...
def _eval_side(pack: dict[str, Any], *, hostile: bool) -> dict[str, Any]:
    from production_gate.battery_peukert_on_v1 import evaluate_battery_peukert
    from production_gate.eclipse_umbra_on_v1 import evaluate_eclipse_umbra
    from production_gate.fourier_flux_on_v1 import evaluate_fourier_flux
    from production_gate.rad_damage_tid_on_v1 import evaluate_rad_damage_tid
