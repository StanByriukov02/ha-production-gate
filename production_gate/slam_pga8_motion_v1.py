...
from production_gate.clifford_motor7_pga8_bridge_v0 import (
    motor7_quat_to_pga8_rotor,
    pga8_rotor_to_motor7_quat,
)
from production_gate.clifford_pga8_motor_v1 import MotorPGA8

if TYPE_CHECKING:
    from production_gate.slam_se3_motor_v1 import Motor, Vec3
...
class SlamPose:
    ...
    def compose(cls, delta: "Motor", acc: SlamPose) -> SlamPose:
        ...
        from production_gate.slam_se3_motor_v1 import compose_motors
    ...
    def rmse_vs_motor7(self, points: list["Vec3"]) -> float:
        ...
        from production_gate.slam_se3_motor_v1 import rmse_m
