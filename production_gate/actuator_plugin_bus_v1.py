...
class Lc2IronTeachingPlugin:
    ...
    def __init__(self, *, joint_count: int | None = None) -> None:
        from production_gate.manipulator_lc2_iron_hal_v1 import ManipulatorLc2IronHal
...
class Xm430SyntheticTtlPlugin:
    ...
    def __init__(self) -> None:
        from production_gate.synthetic_actuator_link_v1 import SyntheticXm430TtlLink
...
def run_actuator_plugin_smoke() -> dict[str, Any]:
    from production_gate.kinematic_chain_ir_v1 import list_chain_ids
