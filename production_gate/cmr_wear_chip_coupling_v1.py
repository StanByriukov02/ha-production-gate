...
def build_wear_chip_stress_row(
    ...
    *,
    ...
    from production_gate.material_tick_ingress_v1 import resolve_tick_ingress
...
def apply_wear_chip_tick(state: dict[str, Any], carrier_id: str) -> dict[str, Any]:
    ...
    if bus.get("iron_mmio_enabled"):
        from production_gate.cmr_wear_iron_mmio_coupling_v1 import apply_wear_chip_tick_iron_mmio
