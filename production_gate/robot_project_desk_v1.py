...
def _read_json(path: Path) -> dict[str, Any]:
    from production_gate.atomic_json_v1 import atomic_read_json
...
def prune_projects(
    *,
    ...
    Prefer keeping projects with body/last_run. Spam from gate create loops dies.
    """
    import shutil
...
def create_project(*, name: str | None = None, preset_id: str | None = None) -> dict[str, Any]:
    ...
    # Soft auto-prune when desk is drowning (gate spam)
    try:
...
def attach_body_from_preset(project_id: str, preset_id: str) -> dict[str, Any]:
    ...
    from production_gate.body_identity_v1 import write_body_identity_artifact
    ...
    from production_gate.silicon_fuse_v1 import bind_body_to_silicon_fuse
...
def attach_body_from_json_pack(
    ...
    *,
    ...
    from production_gate.full_body_compose_v1 import load_full_body_spec, validate_region_honesty
...
def attach_fleet_state(
    ...
    *,
    ...
    from production_gate.fleet_state_contract_v1 import validate_fleet_state
...
def attach_policy_port(
    ...
    *,
    ...
    from production_gate.policy_port_contract_v1 import parse_proposals_jsonl
