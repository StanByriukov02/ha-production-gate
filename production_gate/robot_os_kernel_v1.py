...
from production_gate.fleet_handoff_protocol_v1 import build_handoff_packet
from production_gate.fleet_relay_plan_v1 import hop_for_donor, is_terminal
from production_gate.robot_os_clifford_bind_v1 import stack_replay_hash_from_state
from production_gate.robot_os_sched_policy_v1 import (
    CommandQueue,
    PROOF_TIER,
    default_wh_budget,
    wh_budget_gate,
...
class RobotOsKernel:
    ...
    def _tick_traverse(self, state: dict[str, Any]) -> None:
        ...
        if lie_cfg.get("enabled"):
            from production_gate.lie_integrator_port_v1 import advance_traverse_segment_lie
        ...
        from production_gate.cmr_wear_chip_coupling_v1 import apply_wear_chip_tick
