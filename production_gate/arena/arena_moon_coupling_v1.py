...
from production_gate.arena.eds_2r_d2_hook_v1 import d2_soiling_hook
from production_gate.arena.eds_2r_transport_v1 import simulate_transport_tw
from production_gate.lunar_dust_ingress_v1 import (
    SiteZone,
    electrostatic_index,
...
def moon_tile_environment(
    *,
    ...
    if nowcast_row is None and use_nowcast and zone == "rim_sun":
        from production_gate.lunar_weather_nowcast_v1 import orient_for_arena
    ...
    if nowcast_row:
        ...
        from production_gate.lunar_charging_proxy_v1 import charging_proxy_dict
...
def write_live_nowcast_arena_receipt(*, refresh_measured: bool = True, ephemeris_bind_only: bool = False) -> dict[str, Any]:
    ...
    from production_gate.lunar_weather_nowcast_v1 import orient_row_from_receipt, write_nowcast_receipt
