...
def _thermal_column_defaults(regime_id: str = "rim_sunlit") -> ThermalColumnV1:
    from production_gate.universe_env_thermal_column_v1 import column_init_from_binds
...
def fresh(
    ...
    *,
    ...
    from production_gate.universe_env_radiation_v1 import radiation_env_defaults
