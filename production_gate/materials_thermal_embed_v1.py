...
def _mat_pack() -> dict[str, Any]:
    from production_gate.materials_hooke_cte_on_v1 import load_materials_catalog
...
def _peer_sigma(*, condition: ConditionId, pack: dict[str, Any]) -> float:
    from production_gate.materials_hooke_cte_on_v1 import evaluate_materials_hooke
