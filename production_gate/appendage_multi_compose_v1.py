...
def _mount_ee_world(ee_local: dict[str, Any], mount: dict[str, Any]) -> dict[str, float]:
    from production_gate.appendage_mount_se3_v1 import mount_ee_world

    return mount_ee_world(ee_local, mount, use_se3=True)


def init_multi_appendage_robot(spec: dict[str, Any]) -> dict[str, Any]:
    from production_gate.appendage_stack_integrator_v1 import default_stack_state
    ...
    for aid, row in appendages.items():
        ...
        from production_gate.actuator_plugin_bus_v1 import resolve_actuator_plugin
...
def multi_appendage_tick(
    ...
    *,
    ...
    from production_gate.appendage_stack_integrator_v1 import appendage_stack_tick
