...
def _magnitude_from_bekker_physics(
    ...
    from production_gate.dual_spent_normalize_v1 import dual_share_spent_j
...
def _spent_from_bekker_work(
    ...
    if isinstance(physics, dict) and physics.get("compaction_resistance_n") is not None:
        ...
        from production_gate.drive_chain_embed_v1 import parasitic_spent_add_j
...
def build_energy_claim_from_actuation(
    ...
    *,
    ...
    from production_gate.ballistics_kepler_embed_v1 import apply_ballistics_kepler_to_spent
    from production_gate.dust_envelope_embed_v1 import apply_dust_envelope_to_spent
    from production_gate.env_budget_embed_v1 import apply_env_budget_to_spent
    from production_gate.storm_env_embed_v1 import apply_storm_env_to_spent
    from production_gate.traverse_mechanical_embed_v1 import apply_traverse_mechanical_to_spent
    from production_gate.materials_thermal_embed_v1 import apply_materials_thermal_to_spent
    from production_gate.orbit_residual_embed_v1 import apply_orbit_residual_to_spent
    from production_gate.thermal_world_embed_v1 import apply_thermal_world_to_spent
    from production_gate.isru_sinter_embed_v1 import apply_isru_sinter_to_spent
    from production_gate.atm_drag_embed_v1 import apply_atm_drag_to_spent
    from production_gate.acoustic_embed_v1 import apply_acoustic_to_spent
    from production_gate.li_qc_embed_v1 import apply_li_qc_to_spent
    from production_gate.albedo_dose_embed_v1 import apply_albedo_dose_to_spent
    from production_gate.dust_ingress_embed_v1 import apply_dust_ingress_to_spent
    from production_gate.janosi_embed_v1 import apply_janosi_to_spent
    from production_gate.radiation_rate_embed_v1 import apply_radiation_rate_to_spent
    from production_gate.regolith_thermal_embed_v1 import apply_regolith_thermal_to_spent
