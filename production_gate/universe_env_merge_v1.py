...
from production_gate.lunar_dust_ingress_v1 import accumulation_after_sols, ingress_rate_g_m2_per_sol
from production_gate.universe_env_state_v1 import ActiveWindow, EnvironmentStateV1
...
def integrate_radiation_window(
    ...
    *,
    ...
    from production_gate.lunar_radiation_proxy_v1 import (
