...
def sync_silicon_fuse_after_gate(project_id: str, gate: dict[str, Any]) -> dict[str, Any]:
    ...
    from dogfood_platform.silicon_fuse_v1 import (
        blow_silicon_fuse,
        ensure_silicon_fuse,
        status_silicon_fuse,
    )
...
def build_physics_gate_for_run(
    ...
    *,
    ...
    from dogfood_platform.failure_mode_gate_v1 import apply_failure_modes_to_physics
    from dogfood_platform.silicon_fuse_v1 import ensure_silicon_fuse, status_silicon_fuse
