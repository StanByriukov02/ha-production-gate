...
Run: python -m dogfood_platform.robot_carrier_sim_runtime_v1 --carrier scout_A
...
from dogfood_platform.fleet_live_state_v1 import DEFAULT_STATE, read_state, update_state
from dogfood_platform.fleet_relay_plan_v1 import terminal_carrier
from dogfood_platform.robot_os_hal_sim_v1 import attach_sim_hal_to_kernel
from dogfood_platform.robot_os_kernel_v1 import PROOF_TIER, RobotOsKernel
...
def _tick_via_kernel(carrier_id: str, state: dict[str, Any]) -> dict[str, Any]:
    ...
    if use_lunar_hal:
        from dogfood_platform.robot_os_hal_lunar_profile_v1 import attach_lunar_hal_to_kernel
