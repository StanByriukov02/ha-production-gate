...
def _traverse_frames_dq_pose(
    ...
    *,
    ...
    from dogfood_platform.slam_pose_dq_v1 import DqPose
...
def _traverse_frames_cga32_pose(
    ...
    *,
    ...
    from dogfood_platform.slam_pose_cga32_v1 import Cga32Pose
...
def _compose_motor7(delta: Motor, acc: Motor) -> Motor:
    ...
    from dogfood_platform.slam_se3_motor_v1 import motor_from_matrix4
