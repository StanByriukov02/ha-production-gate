...
def run_gripper_subchain_smoke(*, build: bool = False) -> dict[str, Any]:
    from dogfood_platform.appendage_stack_integrator_v1 import appendage_stack_tick, default_stack_state
    from dogfood_platform.contact_friction_model_v1 import evaluate_coulomb_contact
    from dogfood_platform.kinematic_chain_ir_v1 import clear_chain_overlay, resolve_chain_spec
    ...
    from dogfood_platform.appendage_mount_se3_v1 import mount_ee_world_translate
