...
def init_biped_robot(spec: dict[str, Any] | None = None) -> dict[str, Any]:
    from dogfood_platform.appendage_multi_compose_v1 import init_multi_appendage_robot
...
def biped_tick(robot: dict[str, Any], *, dt: float = 0.005) -> dict[str, Any]:
    from dogfood_platform.appendage_multi_compose_v1 import multi_appendage_tick
    from dogfood_platform.hexapod_foot_contact_v1 import evaluate_hexapod_foot_contact
