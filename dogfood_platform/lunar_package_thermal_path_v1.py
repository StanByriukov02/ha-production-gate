...
from dogfood_platform.lunar_lc2_package_harness_v1 import (
    _FGM_BRANCH,
    _REGOLITH_RHO_BRANCH,
    harness_for_stack,
    resolve_stack_layers,
)
from dogfood_platform.lunar_zone_table_v1 import ZONES, polar_delta_t_k, zone_snapshot
from dogfood_platform.lunar_site_geometry_v1 import rim_duty_for_embed, shackleton_path_profile
