...
def _refresh_ee_from_joints(carrier: dict[str, Any], *, g: float, build: bool) -> dict[str, Any]:
    ...
    try:
        from dogfood_platform.manipulator_ee_pose_cxx_parity_v1 import motor7_to_rotor_hex
...
def _advance_joint_dynamics(
    ...
    *,
    ...
    from dogfood_platform.manipulator_iron_hal_port_v1 import resolve_manipulator_iron_hal_port
...
def advance_manipulator_tick(
    ...
    *,
    ...
    try:
        from dogfood_platform.fleet_construct_arm_coord_v1 import apply_construct_arm_coord_before_tick
    ...
    try:
        from dogfood_platform.robot_os_manipulator_governed_actuation_v1 import (
    ...
    if mutex == "arm_move":
        ...
        try:
            from dogfood_platform.robot_os_manipulator_governance_interceptor_v1 import (
                clip_joint_torques,
        ...
        from dogfood_platform.manipulator_grasp_force_port_v1 import load_grasp_force_envelope
        from dogfood_platform.manipulator_grasp_loop_v1 import advance_grasp_force_tick
    ...
    try:
        from dogfood_platform.fleet_construct_arm_coord_v1 import apply_construct_arm_coord_after_tick
...
def run_manipulator_hal_smoke(*, build: bool = True) -> dict[str, Any]:
    ...
    from dogfood_platform.robot_os_hal_sim_v1 import attach_sim_hal_to_kernel
    from dogfood_platform.robot_os_kernel_v1 import RobotOsKernel
