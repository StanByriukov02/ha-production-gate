...
from dogfood_platform.robot_os_newton_x_policy_dual_run_v1 import (
    DEFAULT_CARRIER_ID,
    DEFAULT_PROFILE_ID,
...
from dogfood_platform.terramech_bekker_on_v1 import hostile_bekker_physics, safe_bekker_physics
from dogfood_platform.robot_os_policy_port_v1 import BACKEND_REGOLITH_PLANNER, BACKEND_STUB
...
def _manipulator_grasp_kpi_for_condition(
    ...
    *,
    ...
    if not _is_manipulator_project(project):
        return None
    from dogfood_platform.manipulator_grasp_force_port_v1 import grasp_force_step_native
...
def run_project(project_id: str, condition: ConditionId) -> dict[str, Any]:
    ...
    from dogfood_platform.field_world_bind_v1 import physics_pair_for_field
    from dogfood_platform.start_here_session_v1 import load_session
    ...
    from dogfood_platform.drive_chain_embed_v1 import attach_drive_chain_to_physics

    physics = attach_drive_chain_to_physics(physics, condition=condition)
    from dogfood_platform.env_budget_embed_v1 import attach_env_budget_to_physics

    physics = attach_env_budget_to_physics(physics, condition=condition)
    from dogfood_platform.storm_env_embed_v1 import (
    ...
    from dogfood_platform.slope_rut_embed_v1 import attach_slope_rut_to_physics

    physics = attach_slope_rut_to_physics(physics, condition=condition)
    from dogfood_platform.traverse_mechanical_embed_v1 import (
    ...
    from dogfood_platform.fatigue_optics_embed_v1 import (
    ...
    from dogfood_platform.dust_envelope_embed_v1 import attach_dust_envelope_to_physics

    physics = attach_dust_envelope_to_physics(physics, condition=condition)
    from dogfood_platform.materials_thermal_embed_v1 import (
    ...
    from dogfood_platform.orbit_residual_embed_v1 import attach_orbit_residual_to_physics

    physics = attach_orbit_residual_to_physics(physics, condition=condition)
    from dogfood_platform.ballistics_kepler_embed_v1 import (
    ...
    from dogfood_platform.thermal_world_embed_v1 import (
    ...
    from dogfood_platform.isru_sinter_embed_v1 import (
    ...
    from dogfood_platform.dust_ingress_embed_v1 import (
    ...
    from dogfood_platform.envelope_refuse_v1 import attach_envelope_refuse_to_physics

    physics = attach_envelope_refuse_to_physics(physics, condition=condition)
    from dogfood_platform.regolith_thermal_embed_v1 import (
    ...
    from dogfood_platform.silicon_fuse_v1 import ensure_silicon_fuse, fuse_path_for_project
    ...
    from dogfood_platform.artifact_existence_law_v1 import build_actuation_truth
    from dogfood_platform.energy_claim_v1 import build_energy_claim_from_actuation
    from dogfood_platform.physics_gate_v1 import (
    ...
    from dogfood_platform.desk_closed_loop_v1 import build_closed_loop_v1
    ...
    from dogfood_platform.foundation_closed_loop_fold_v1 import fold_foundation_into_closed_loop
    ...
    from dogfood_platform.physics_os_kernel_v1 import seal_kernel_on_run
    ...
    try:
        from dogfood_platform.desk_visitor_v1 import remember_scene
        from dogfood_platform.start_here_session_v1 import load_session, write_session
