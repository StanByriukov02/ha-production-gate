...
from dogfood_platform.open_seed_paths_v1 import dust_ingress_bind_path, materials_registry_path
...
def read_factory_slot_value(slot_id: str) -> Any | None:
    from dogfood_platform.robot_factory_slots_v1 import load_slots
...
def promote_active_tread_variant(
    ...
    *,
    ...
    from dogfood_platform.robot_factory_slots_v1 import load_slots, save_slots, set_slot
