...
from dogfood_platform.lunar_regolith_bearing_v1 import shackleton_default_bearing_state
from dogfood_platform.lunar_site_geometry_v1 import shackleton_path_profile
...
from dogfood_platform.universe_coupling_v1 import mechanical_coupling_slice
...
def _jerk_teaching_scale() -> float:
    ...
    from dogfood_platform.universe_coupling_v1 import coupling_teaching_scales
