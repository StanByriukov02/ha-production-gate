...
def _janosi_pack(*, p_kpa: float | None = None) -> dict[str, Any]:
    from dogfood_platform.janosi_shear_curve_on_v1 import load_janosi_curve_catalog
...
def _peer_metric(*, condition: ConditionId, pack: dict[str, Any]) -> float:
    from dogfood_platform.janosi_shear_curve_on_v1 import evaluate_janosi_curve
