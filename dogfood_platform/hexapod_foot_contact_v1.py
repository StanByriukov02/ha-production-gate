...
def hexapod_gait_contact_tick(
    ...
    *,
    ...
    from dogfood_platform.hexapod_gait_bus_v1 import hexapod_gait_tick
...
def run_hexapod_foot_contact_smoke(*, ticks: int = 20) -> dict[str, Any]:
    ...
    from dogfood_platform.hexapod_gait_bus_v1 import init_gait_bus
    ...
    from dogfood_platform.contact_friction_model_v1 import load_friction_catalog, resolve_friction_pair
