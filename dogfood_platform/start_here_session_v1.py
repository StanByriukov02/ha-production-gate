...
def ensure_desk_boot(*, force_clean: bool = False) -> dict[str, Any]:
    ...
    from dogfood_platform.desk_visitor_v1 import is_first_open, last_scene, mark_open
    ...
    if force_clean or is_first_open():
        ...
        try:
            from dogfood_platform.robot_project_desk_v1 import clear_active_project
    ...
    active_id = None
    try:
        from dogfood_platform.desk_visitor_v1 import status as visitor_status
...
def write_session(doc: dict[str, Any]) -> dict[str, Path]:
    from dogfood_platform.atomic_json_v1 import atomic_write_text
...
def load_session() -> dict[str, Any]:
    from dogfood_platform.atomic_json_v1 import atomic_read_text
    ...
    doc = {
        ...
        "pane_hints": {
            ...
            "receipt": (
                ...
                "Full builder UI is NOT here — dogfood recipe receipt is the proof."
            ),
        },
        "cta": {
        ...
        "honesty": {
            "not_full_builder": True,
            "not_product_ready": True,
            "assembly_via_dogfood_recipes": True,
