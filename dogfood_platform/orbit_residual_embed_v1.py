...
def _orbit_pack() -> dict[str, Any]:
    from dogfood_platform.free_mol_drag_on_v1 import load_fmd_catalog
    from dogfood_platform.solar_pressure_on_v1 import load_srp_catalog
    from dogfood_platform.trapped_belt_on_v1 import load_belt_catalog
...
def _peer_metric(*, condition: ConditionId, pack: dict[str, Any]) -> float:
    from dogfood_platform.free_mol_drag_on_v1 import evaluate_free_mol_drag
    from dogfood_platform.solar_pressure_on_v1 import evaluate_solar_pressure
    from dogfood_platform.trapped_belt_on_v1 import evaluate_trapped_belt
