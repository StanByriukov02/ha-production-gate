...
_SPEC = "docs/agent_workflow/DOGFOOD_SITUATION_INHERIT_STATE_OBJECT_V1.md"
_COMPASS = "docs/agent_workflow/DOGFOOD_COMPASS_ACTION_REGISTER_20260706_V1.md"
...
def _path_energy_model(
    *,
    ...
    from dogfood_platform.slam_mission_energy_ledger_v1 import (
