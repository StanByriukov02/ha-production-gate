...
def _profile_zone(profile_id: str) -> str:
    from dogfood_platform.robot_os_hal_lunar_profile_v1 import _PROFILE_ZONE
...
def evaluate_lunar_row_with_material(
    ...
    *,
    ...
    from dogfood_platform.material_physics_port_v1 import compute_env_in_from_material
    from dogfood_platform.robot_os_hal_lunar_profile_v1 import WORLD_ID, WORLD_ORACLE, G_MOON_MPS2
...
def attach_material_physics_to_carrier(
    ...
    *,
    ...
    if step_m is None:
        ...
        from dogfood_platform.robot_os_kernel_v1 import SEGMENT_TICKS
...
def resolve_tick_ingress(
    ...
    from dogfood_platform.cmr_wear_chip_coupling_v1 import _traverse_fraction
