...
from dogfood_platform.robot_os_policy_port_v1 import BACKEND_REGOLITH_PLANNER, RegolithPlannerBackend
...
def read_wear_stress_row(state: dict[str, Any], carrier_id: str) -> dict[str, Any]:
    ...
    from dogfood_platform.cmr_wear_chip_coupling_v1 import build_wear_chip_stress_row
...
def _terminal_stressed_state(*, profile_id: str = "lunar_crater_5km") -> dict[str, Any]:
    ...
    from dogfood_platform.cmr_wear_chip_coupling_v1 import apply_wear_chip_tick, init_wear_chip_bus
