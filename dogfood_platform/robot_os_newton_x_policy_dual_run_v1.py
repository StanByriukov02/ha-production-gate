...
from dogfood_platform.robot_os_hal_lunar_profile_v1 import G_MOON_MPS2, ORACLE as REGOLITH_ORACLE
from dogfood_platform.robot_os_newton_x_world_step_v1 import WORLD_ID, init_newton_x_world
from dogfood_platform.robot_os_policy_port_v1 import (
...
def bad_sinkage_lunar_physics() -> dict[str, Any]:
    ...
    from dogfood_platform.terramech_bekker_on_v1 import physics_row_for_dual
...
def _prepare_sinkage_probe_state(
    *,
    ...
    from dogfood_platform.cmr_wear_chip_coupling_v1 import init_wear_chip_bus
    from dogfood_platform.fleet_live_state_v1 import empty_state
    from dogfood_platform.fleet_relay_plan_v1 import segment_bounds, terminal_carrier
    from dogfood_platform.robot_os_clifford_bind_v1 import apply_clifford_bind
    ...
    if silicon_fuse_path:
        from dogfood_platform.silicon_fuse_v1 import load_fuse_into_governance_state
...
def probe_one_tick_actuation_at_sinkage(
    *,
    ...
    from dogfood_platform.robot_carrier_sim_runtime_v1 import _tick_via_kernel
    from dogfood_platform.robot_os_governed_actuation_v1 import init_governance_bind
