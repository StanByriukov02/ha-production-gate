...
def evaluate_artifact_existence(
    ...
    *,
    ...
    from dogfood_platform.artifact_law_v1 import verify_project
    from dogfood_platform.robot_project_desk_v1 import project_dir
    ...
    try:
        from dogfood_platform.desk_closed_loop_v1 import require_closed_loop_consequence
...
def require_artifact_existence(
    ...
    *,
    ...
    Reliability default (years-forward):
      ...
      No IRON file → emit still allowed after Dual∧closed_loop (local dogfood).
    Env:
    ...
    from dogfood_platform.artifact_law_v1 import ArtifactLawError, require_rust_artifact_law
    from dogfood_platform.silicon_fuse_v1 import ensure_silicon_fuse
