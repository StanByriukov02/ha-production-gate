...
def _catalog_temps() -> tuple[float, float, float]:
    from dogfood_platform.vacuum_radiative_bc_on_v1 import load_radiative_bc_catalog
...
def evaluate_thermal_world(*, condition: ConditionId, budget_j: float = EMBED_SLICE_J) -> dict[str, Any]:
    ...
    from dogfood_platform.regolith_thermal_on_v1 import load_regolith_thermal_catalog
    from dogfood_platform.thermal_column_on_v1 import ORACLE as COLUMN_ORACLE
    from dogfood_platform.thermal_column_on_v1 import evaluate_column_step
    ...
    from dogfood_platform.vacuum_radiative_bc_on_v1 import evaluate_radiative_bc
