...
from dogfood_platform.robot_os_governance_eer_session_v1 import init_eer_session, record_eer_step
from dogfood_platform.robot_os_governance_interceptor_v1 import evaluate_for_profile, record_action_receipt
from dogfood_platform.robot_os_governance_types_v1 import ActionReceipt, init_governance_state
from dogfood_platform.robot_os_hal_v1 import ActuationCommand, ActuationState, RobotOsHalStack
from dogfood_platform.robot_os_policy_port_v1 import (
    BACKEND_STUB,
    init_policy_port_bind,
    resolve_policy_port,
)
from dogfood_platform.robot_os_policy_stub_v1 import DEFAULT_INJECT_BAD_AT
...
def apply_governance_before_actuation(
    ...
    from dogfood_platform.robot_os_governance_types_v1 import GovernanceVerdict
