"""Optional eer-0.1 session accumulator for closed-loop dogfood governance.
...
from dogfood_platform.robot_os_governance_eer_bridge_v1 import evidence_engine_available
from dogfood_platform.robot_os_governance_interceptor_v1 import ACTION_ONLY_SOURCES
...
def init_eer_session(state: dict[str, Any], *, profile_id: str = "lunar_crater_5km") -> bool:
    ...
    backend = str((state.get("governance") or {}).get("policy_port", {}).get("backend") or "dogfood_policy")
