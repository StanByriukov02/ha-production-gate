        ...
        spikes.extend(
            [
                ...
                },
                {
                    ...
                    "severity": "MEDIUM",
                    "pass": all(
                        (_REPO / "dogfood_platform" / f"{v.get('engine')}.py").is_file()
                ...
                },
                {
                    ...
                    "severity": "MEDIUM",
                    "pass": (_REPO / "dogfood_platform/hexapod_planar_urdf_se3_parity_v1.py").is_file(),
        ...
        spikes.extend(
            [
                ...
                },
                {
                    ...
                    "severity": "MEDIUM",
                    "pass": (_REPO / "dogfood_platform/earth_lunar_motion_compose_v1.py").is_file(),
