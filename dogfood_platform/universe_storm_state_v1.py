...
from dogfood_platform.universe_state_v1 import EpsilonRow, HopState, UniverseStateBus
...
def run_concurrent_storm_env_physics(
    ...
    *,
    ...
    from dogfood_platform.universe_env_merge_v1 import integrate_laws, sequential_merge_env
    from dogfood_platform.universe_env_state_v1 import fresh as env_fresh
...
def selftest() -> None:
    from dogfood_platform.universe_storm_engine_v1 import compose_storm
