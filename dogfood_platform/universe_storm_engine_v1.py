...
from dogfood_platform.universe_event_dispatch_v1 import apply_event
from dogfood_platform.universe_event_sampler_v1 import (
    draw_event_params,
    load_event_catalog,
    sample_events_stratified,
)
from dogfood_platform.universe_immersion_v1 import (
    check_budget,
...
def immerse_target(
    ...
    *,
    ...
    if target_id == "rocket":
        from dogfood_platform.rocket_storm_target_v1 import immerse_rocket_target
...
def immerse_in_storm_concurrent(
    ...
    *,
    ...
    from dogfood_platform.universe_storm_state_v1 import run_concurrent_storm
...
def selftest() -> None:
    from dogfood_platform.universe_immersion_v1 import list_target_ids
    ...
    from dogfood_platform.universe_event_dispatch_v1 import macro_cosmic_dispatch_audit
