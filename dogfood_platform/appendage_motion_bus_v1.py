...
def resolve_bus_for_role(role: str) -> dict[str, Any]:
    from dogfood_platform.appendage_role_taxonomy_v1 import resolve_motion_bus_for_role
...
def robot_tick(
    ...
    *,
    ...
    from dogfood_platform.appendage_multi_compose_v1 import init_multi_appendage_robot, multi_appendage_tick
    from dogfood_platform.biped_leg_compose_v1 import biped_q_cmd, init_biped_robot
    from dogfood_platform.head_neck_pan_tilt_v1 import look_at_q_cmd
    ...
    for row in regions:
        ...
        if role == "wheel_axle" or "wheeled" in str(row.get("bus") or ""):
            from dogfood_platform.rolling_kinematics_crown_v1 import load_rolling_spec
...
def run_appendage_motion_bus_smoke() -> dict[str, Any]:
    ...
    from dogfood_platform.appendage_role_taxonomy_v1 import load_role_taxonomy
    ...
    checks = {
        ...
        in ("DOGFOOD_ACTIVE", "DOGFOOD_ONLY"),
