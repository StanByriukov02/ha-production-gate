...
def _drive_pack() -> dict[str, Any]:
    from dogfood_platform.dc_motor_gear_on_v1 import load_dc_motor_catalog
    from dogfood_platform.joint_friction_on_v1 import load_joint_catalog
...
def evaluate_drive_chain(
    *,
    ...
    from dogfood_platform.dc_motor_gear_on_v1 import evaluate_dc_motor_gear
    from dogfood_platform.dual_spent_normalize_v1 import dual_share_receipt
    from dogfood_platform.joint_friction_on_v1 import evaluate_joint_friction
